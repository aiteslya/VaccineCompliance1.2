...
TblBEL = readtable('DataVaccineAdd/Belarus.csv');
TblISR = readtable('DataVaccineAdd/Israel.csv');
TblNED = readtable('DataVaccineAdd/Netherlands.csv');
TblPOR = readtable('DataVaccineadd/Portugal.csv');
